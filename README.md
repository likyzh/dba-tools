...
#### 首先谈谈dba-tool的起源：
    ...
    所有的系统／平台／脚本的出现都不是一蹴而就、漫无目的的、可能只是为了解决当初一个小小的痛点、又或者只是图自己一时爽快、甚至是一时兴起，同样这个工具集的诞生也是一个小小的问题。

    这个工具集来源于我的吐槽，我抱怨为什么每次登陆数据库都要敲那么厂的命令，为什么看了监控我都要输入mysqladmin xxxx，也许只有会叫人才会有想去解决的冲动，当然我只负责BB。
